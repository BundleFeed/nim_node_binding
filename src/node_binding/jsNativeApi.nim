...
proc napi_get_all_property_names*(env: napi_env, obj: napi_value, key_mode: NapiKeyCollectionMode, key_filter: NapiKeyFilter, key_conversion: NapiKeyConversion, result: ptr napi_value): NapiStatus {.header: "<node_api.h>".}
