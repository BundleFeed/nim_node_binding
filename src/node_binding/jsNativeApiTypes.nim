...
type NapiKeyCollectionMode* {.importc: "napi_key_collection_mode", header:"<node_api.h>".} = enum
  napi_key_include_prototypes
  napi_key_own_only

type NapiKeyConversion* {.importc: "napi_key_conversion", header:"<node_api.h>".} = enum
  napi_key_keep_numbers
  napi_key_numbers_to_strings

type NapiKeyFilter* {.importc: "napi_key_filter", header:"<node_api.h>".} = enum
  napi_key_all_properties = 0
  napi_key_writable = 1
  napi_key_enumerable = 1 shl 1
  napi_key_configurable = 1 shl 2
  napi_key_skip_strings = 1 shl 3
  napi_key_skip_symbols = 1 shl 4
